...
@router.post("/search", response_model=RetrievalResponse, summary="Search documents", description="Vector search across ingested document chunks. Supports filtering by document ID, file type, and content type (text, image_description, table_content). Returns ranked results with similarity scores and source metadata.")
